...
const viewAsHtml = ref<boolean>(props.message.template.content.type === "text/html");
...
<template>
  <section>
    ...
    <app-accordion>
      <app-accordion-item :title="`messages.contents.type.options.${message.template.content.type}`">
        <div class="mb-3">
