...
public class ReadConfigurationQueryTests : IntegrationTests
{
  ...
  [Fact(DisplayName = "It should return null when the configuration is not cached.")]
  public async Task It_should_return_null_when_the_configuration_is_not_cached()
  {
