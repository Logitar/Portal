...
namespace Logitar.Portal.EntityFrameworkCore.SqlServer.Migrations
{
    ...
    [Migration("20240125053216_CreateRealmTable")]
            ...
            modelBuilder.Entity("Logitar.Portal.EntityFrameworkCore.Relational.Entities.RealmEntity", b =>
                {
                    ...
                    b.Property<string>("PasswordsHashingStrategy")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");
                    ...
                    b.Property<int>("PasswordsRequiredLength")
                        .HasColumnType("int");

                    b.Property<int>("PasswordsRequiredUniqueChars")
                        .HasColumnType("int");
