...
namespace Logitar.Portal.Infrastructure.Migrations
{
    ...
    [Migration("20230206145757_LogActivities")]
    partial class LogActivities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Logitar.Portal.Infrastructure.Entities.LogEntity", b =>
                {
            ...
            modelBuilder.Entity("Logitar.Portal.Infrastructure.Entities.LogEventEntity", b =>
                {
                    b.Property<long>("EventId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Logitar.Portal.Infrastructure.Entities.RecipientEntity", b =>
                {
                    ...
                    b.Property<string>("DisplayName")
                        .HasMaxLength(383)
                        .HasColumnType("character varying(383)");
            ...
            modelBuilder.Entity("Logitar.Portal.Infrastructure.Entities.LogEventEntity", b =>
                {
                    b.HasOne("Logitar.Portal.Infrastructure.Entities.EventEntity", "Event")
                        .WithOne("Log")
                        .HasForeignKey("Logitar.Portal.Infrastructure.Entities.LogEventEntity", "EventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Logitar.Portal.Infrastructure.Entities.LogEntity", "Log")
                        .WithMany("Events")
                        .HasForeignKey("LogId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
