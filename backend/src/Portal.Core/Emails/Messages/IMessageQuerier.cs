namespace Portal.Core.Emails.Messages
{
  public interface IMessageQuerier
  {
    ...
    Task<PagedList<Message>> GetPagedAsync(bool? hasErrors = null, bool? isDemo = null, Guid? realmId = null, string? search = null, bool? succeeded = null, Guid? templateId = null,
