...
public static class DependencyInjectionExtensions
{
  ...
  {
    return services
      .AddDbContext<PortalContext>(options => options.UseNpgsql(connectionString, builder => builder.MigrationsAssembly("Logitar.Portal.EntityFrameworkCore.PostgreSQL")))
