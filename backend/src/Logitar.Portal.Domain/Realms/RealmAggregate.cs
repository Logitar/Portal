...
public class RealmAggregate : AggregateRoot
{
  ...
  public RealmAggregate(UniqueSlugUnit uniqueSlug, ActorId actorId = default, RealmId? id = null)
    : base((id ?? RealmId.NewId()).AggregateId)
  {
    Raise(new RealmCreatedEvent(actorId, uniqueSlug));
  }
