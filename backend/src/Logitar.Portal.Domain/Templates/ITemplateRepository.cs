...
public interface ITemplateRepository
{
  ...
  Task<IEnumerable<Template>> LoadAsync(CancellationToken cancellationToken = default);
  Task<IEnumerable<Template>> LoadAsync(TenantId? tenantId, CancellationToken cancellationToken = default);
