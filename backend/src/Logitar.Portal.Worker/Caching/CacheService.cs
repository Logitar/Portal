...
internal class CacheService : ICacheService
{
  ...
  public SentMessages? GetSentMessages(Guid correlationId) => GetItem<SentMessages>(GetSentMessagesKey(correlationId));
  public void SetSentMessages(Guid correlationId, SentMessages sentMessages) => SetItem(GetSentMessagesKey(correlationId), sentMessages);
