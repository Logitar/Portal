...
internal class DisabledChangedHandler : INotificationHandler<DisabledChanged>
{
  private readonly IActorService _actorService;
  private readonly PortalContext _context;

  public DisabledChangedHandler(IActorService actorService, PortalContext context)
  {
    _actorService = actorService;
    _context = context;
  }

  public async Task Handle(DisabledChanged notification, CancellationToken cancellationToken)
  {
    ...
    user.SetDisabled(notification, actor);
