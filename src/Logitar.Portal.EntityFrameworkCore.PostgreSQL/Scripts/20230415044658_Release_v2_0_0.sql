...
CREATE TABLE "DeleteActions" (
    "Value" integer NOT NULL,
    "Name" character varying(255) NOT NULL,
    CONSTRAINT "PK_DeleteActions" PRIMARY KEY ("Value")
);
...
CREATE TABLE "Events" (
    ...
    "ActorId" character varying(255) NOT NULL DEFAULT 'SYSTEM',
    "OccurredOn" timestamp with time zone NOT NULL DEFAULT (now()),
    "DeleteAction" integer NOT NULL DEFAULT 0,
    "AggregateType" character varying(65535) NOT NULL,
    "AggregateId" character varying(255) NOT NULL,
    "EventType" character varying(65535) NOT NULL,
    "EventData" jsonb NOT NULL,
    CONSTRAINT "PK_Events" PRIMARY KEY ("EventId")
);

INSERT INTO "DeleteActions" ("Value", "Name")
VALUES (0, 'None');
INSERT INTO "DeleteActions" ("Value", "Name")
VALUES (1, 'Delete');
INSERT INTO "DeleteActions" ("Value", "Name")
...
CREATE UNIQUE INDEX "IX_DeleteActions_Name" ON "DeleteActions" ("Name");
...
CREATE INDEX "IX_Events_DeleteAction" ON "Events" ("DeleteAction");
...
VALUES ('20230213183330_CreateEventTables', '7.0.5');
