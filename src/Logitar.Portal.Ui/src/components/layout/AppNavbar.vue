      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <template v-if="account.authenticated">
            ...
            <li class="nav-item">
              <RouterLink :to="{ name: 'UserList' }" class="nav-link"> <font-awesome-icon icon="fas fa-users" /> {{ t("users.title.list") }} </RouterLink>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <RouterLink :to="{ name: 'DictionaryList' }" class="nav-link">
                <font-awesome-icon icon="fas fa-language" /> {{ t("dictionaries.title.list") }}
              </RouterLink>
            </li>
            <li class="nav-item">
              <RouterLink :to="{ name: 'SenderList' }" class="nav-link">
                <font-awesome-icon icon="fas fa-paper-plane" /> {{ t("senders.title.list") }}
              </RouterLink>
            </li>
            <li class="nav-item">
